...
(int | byte | enum | auto | bool | short | double | char | long | float | double | string | void ) {return new Symbol(sym.T_dato, yychar, yyline, yytext());}
(private| public| private | protected) { return new Symbol(sym.variables_glo, yychar, yyline, yytext()); }
...
(iostream | conio | math | vector | string | numeric ) {return new Symbol(sym.Libreria, yychar, yyline, yytext());}
